//
// Copyright © 2025 Audinate Pty Ltd ACN 120 828 006 (Audinate). All rights reserved.
//
//
...
/// @file DdhiClient.hpp
/// Lightweight DDHI Client header file
#include <exception>
...
namespace Dante {
    namespace Ddhi {
        ...
        public:
            Client(const std::string & unixSocketPath );
            ~Client();
            void hello(const std::set<std::string>& supportedRpcs = {});
